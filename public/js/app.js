...
$(function () {
    $(".chosen-select").chosen({ width: '100%', disable_search_threshold: 5, no_results_text: 'No se encontrarón resultados' });
});

$(function () {
    var max_fields      = 10;
    var $wrapper         = $(".fields-repeater");
    ...
    $add_button.click(function(e){
        ...
        if(x < max_fields){
            x++;
            $wrapper.append('<div class="form-group inline"><input class="form-control underlined" placeholder="Código Barra" id="bar-code-1" name="bar_code[]" type="text"><button type="button" class="btn btn-secondary btn-sm remove-field"><i class="fa fa-remove"></i></button></div>');
        }
    });
    ...
    $('.datepicker').dcalendarpicker({format: 'dd/mm/yyyy', theme: 'red'});
    $('.datepicker-dashed').dcalendarpicker({format: 'dd-mm-yyyy', theme: 'red'});

    /*$('.nit-autcomplete').autocomplete({
        serviceUrl: '/product/api/search-client',
