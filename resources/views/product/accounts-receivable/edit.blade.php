                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card card-block">
                        <div class="title-block">
                            <h3 class="title">Editar Cuenta por Cobrar</h3>
                        </div>
                        <form method="POST" action="{{ url('product/accounts-receivables/edit', ['id' => $accountsReceivable->id]) }}">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('invoice') ? ' has-error' : '' }}">
                                        ...
                                        <p>
                                            {{ $accountsReceivable->invoice->description }}
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Cliente</label>
                                        <p id="client">{{ $accountsReceivable->client->full_name }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Total</label>
                                        <p id="total">{{ $accountsReceivable->total }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('payment_date') ? ' has-error' : '' }}">
                                        ...
                                        {{ Form::text('payment_date', $accountsReceivable->field_payment_date, ['class' => 'form-control underlined datepicker', 'placeholder' => 'Fecha de pago', 'id' => 'payment-date']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                                        ...
                                        {{ Form::text('amount', $accountsReceivable->creditType->amount, ['class' => 'form-control underlined', 'placeholder' => 'Monto Plazos', 'id' => 'amount']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                        ...
                                        {{ Form::select('status', ['Y' => 'Sí', 'N' => 'No'], $accountsReceivable->raw_status, ['class' => 'form-control chosen-select', 'id' => 'status']) }}
