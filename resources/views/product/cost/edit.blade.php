            ...
            <div class="row sameheight-container">
                <div class="col-md-6 offset-md-3">
                    <div class="card card-block sameheight-item">
                        ...
                        <form role="form" method="POST" action="{{ url('product/costs/edit', ['id' => $cost->id]) }}" novalidate>
                            {{ csrf_field() }}
                            <div class="form-group{{ $errors->has('product') ? ' has-error' : '' }}">
                                <label for="product" class="control-label">Producto</label>
                                {{ Form::select('product', $products, $cost->product->id, ['id' => 'product', 'class' => 'form-control chosen-select']) }}
                            ...
                            <div class="form-group{{ $errors->has('unit_price') ? ' has-error' : '' }}">
                                ...
                                {{ Form::text('unit_price', $cost->unit_price, ['class' => 'form-control underlined', 'placeholder' => 'Precio unitario', 'id' => 'unit-price']) }}
                            ...
                            <div class="form-group{{ $errors->has('unit_cost') ? ' has-error' : '' }}">
                                ...
                                {{ Form::text('unit_cost', $cost->unit_cost, ['class' => 'form-control underlined', 'placeholder' => 'Costo unitario', 'id' => 'unit-cost']) }}
                            ...
                            <div class="form-group{{ $errors->has('wholesale_price') ? ' has-error' : '' }}">
                                ...
                                {{ Form::text('wholesale_price', $cost->wholesale_price, ['class' => 'form-control underlined', 'placeholder' => 'Precio por mayor', 'id' => 'wholesale-price']) }}
