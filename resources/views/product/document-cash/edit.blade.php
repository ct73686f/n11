                ...
                <div class="col-md-6 offset-md-3">
                    <div class="card card-block sameheight-item">
                        <div class="title-block">
                            <h3 class="title">Editar documento efectivo</h3>
                        </div>
                        <form role="form" enctype="multipart/form-data" method="POST" action="{{ url('product/documents-cash/edit', ['id' => $document->id]) }}" novalidate>
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('output_type') ? ' has-error' : '' }}">
                                ...
                                {{ Form::select('output_type', ['E' => 'Entrada Efectivo', 'S' => 'Salida Efectivo'], $document->raw_output_type, ['id' => 'output-type', 'class' => 'form-control chosen-select']) }}
