            ...
            <div class="row sameheight-container">
                <div class="col-md-6 offset-md-3">
                    <div class="card card-block">
                        ...
                        <form role="form" method="POST" action="{{ url('product/documents-cash/new') }}" novalidate>
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('output_type') ? ' has-error' : '' }}">
                                ...
                                {{ Form::select('output_type', ['E' => 'Entrada Efectivo', 'S' => 'Salida Efectivo'], null, ['id' => 'output-type', 'class' => 'form-control chosen-select']) }}
