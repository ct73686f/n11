                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card card-block">
                        <div class="title-block">
                            <h3 class="title">Venta de mercaderia #{{ $invoice->id }}</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    <label for="description" class="control-label">Descuento</label>
                                    <p>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    <label for="description" class="control-label">Sub Total</label>
                                    <p>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <p>
                                        {{ number_format(($invoice->total - $invoice->discount), 2, '.', ',') }}
                                    </p>
                                </div>
                            </div>
                        </div>
