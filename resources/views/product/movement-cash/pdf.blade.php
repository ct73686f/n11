...
<div id="page-wrap">
    <table width="100%" style="padding: 0; margin: 0;">
        ...
        <tr>
            <td>
                <div>
                    <strong>Tipo de Salida:</strong><br>{{ $movement->document->output_type }} <br>
                    <strong>Monto a pagar: </strong> Q. {{ number_format($movement->total, 2, '.', ',') }}
                </div>
            </td>
        </tr>
        </tbody>
    ...
    <table width="100%" class="outline-table">
        ...
        @foreach ($movement->details as $detail)
            <tr>
                ...
                <td class="right">{{ number_format($detail->sub_total, 2, '.', ',') }}</td>
            </tr>
        @endforeach
        ...
        <tr class="border-right">
            ...
            <td class="right border-top">{{ $movement->total }}</td>
        </tr>
        </tbody>
    </table>
    <p>&nbsp;</p>
    ...
    <table>
        ...
        <tr>
            <td>
                <strong>Descripción:</strong> <br> {{ $movement->document->description }}
            </td>
        </tr>
        </tbody>
    </table>
