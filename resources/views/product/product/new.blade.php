            ...
            <div class="row sameheight-container">
                <div class="col-md-6 offset-md-3">
                    <div class="card card-block">
                        ...
                        <form role="form" enctype="multipart/form-data" method="POST" action="{{ url('product/products/new') }}" novalidate>
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('provider') ? ' has-error' : '' }}">
                                ...
                                {{ Form::select('provider[]', $providers, null, ['multiple' => true, 'id' => 'provider', 'class' => 'form-control chosen-select', 'data-placeholder' => 'Seleccione a los proveedores']) }}
                            ...
                            <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                                ...
                                {{ Form::select('category[]', $categories, null, ['multiple' => true, 'id' => 'category', 'class' => 'form-control chosen-select', 'data-placeholder' => 'Seleccione las categorias']) }}
                            ...
                            <div class="form-group{{ $errors->has('bar_code') ? ' has-error' : '' }}">
                                ...
                                {{ Form::text('bar_code', null, ['class' => 'form-control underlined multi-values', 'placeholder' => 'Código Barra', 'id' => 'bar-code', 'data-default' => 'Agregar código de barra']) }}
