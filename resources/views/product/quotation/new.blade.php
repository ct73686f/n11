                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card card-block">
                        <div class="title-block">
                            <h3 class="title">Nueva cotización</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('discount') ? ' has-error' : '' }}">
                            ...
                            {{ Form::text('discount', '0.00', ['class' => 'form-control underlined', 'placeholder' => 'Descuento', 'id' => 'discount']) }}
                    ...
                    <div class="card card-block" id="details-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group{{ $errors->has('wholesale_apply') ? ' has-error' : '' }}">
                                            ...
                                            {{ Form::select('temp_wholesale', ['Y' => 'Sí', 'N' => 'No'], null, ['id' => 'wholesale-apply', 'class' => 'form-control chosen-select', 'data-placeholder' => 'Seleccione una opción']) }}
                        ...
                        <form id="invoice-form" role="form" method="POST" action="{{ url('product/movements/new') }}"
                            ...
                            <div class="form-group">
                                <a href="{{ url('product/quotations') }}" class="btn btn-secondary">Cancelar</a>
    ...
    <script>
        $(function () {
            ...
            $productForm.on('submit', function (e) {
                ...
                if ($.isNumeric(discount)) {
                    $.ajax({
                        url: '{{ url('product/quotations/product') }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            product: product,
                        ...
                        success: function (res) {
                            ...
                            $.ajax({
                                url: '{{ url('product/quotations/product-total') }}',
                                type: 'GET',
                                data: {
                                    _token: '{{ csrf_token() }}',
                                    id: product,
            ...
            $form.on('submit', function (e) {
                ...
                $.ajax({
                    url: '{{ url('product/quotations/new') }}',
                    type: 'POST',
                    data: $form.serialize(),
                    beforeSend: function () {
                    ...
                    success: function (res) {
                        ...
                        window.open(res.url);
                        window.location.href = '{{  url('product/quotations') }}';
                    },
                    error: function (res) {
                        var errors = res.responseJSON;
