                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card card-block">
                        <div class="title-block">
                            <h3 class="title">Cotización #{{ $quotation->id }}</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="card card-block">
                        <div class="title-block">
                            <h3 class="title">Detalle de la Cotización</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                        ...
                        <div class="form-group">
                            <a href="{{ url('product/quotations') }}" class="btn btn-secondary">Regresar a facturas</a>
                            <a class="btn btn-primary" target="_blank" href="{{ url('product/quotations/pdf', ['id' => $quotation->id]) }}">Imprimir PDF</a>
                        </div>
                    </div>
...
@section('page-script')
    <script>
        $(function () {
            ...
            var $quotationDesc      = $('#invoice-desc');
            var $product          = $('#product');
            var $productIds       = $('#product-ids');
            var $quantity         = $('#quantity');
            var $quotationProducts  = $('#invoice-products');
            ...
            $form.on('submit', function (e) {
                ...
                $quotationDesc.val($description.val());
