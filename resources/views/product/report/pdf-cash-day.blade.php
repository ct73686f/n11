<html>
<head>
    <title>Reporte Efectivo del Día</title>
    <style type="text/css">
        #page-wrap {
            width: 700px;
            margin: 0 auto;
...
<div id="page-wrap">
    <table width="100%">
        ...
        <tr>
            ...
            <td width="70%">
                <h2>Reporte de Efectivo del Día</h2><br>
    ...
    <table width="100%" class="outline-table" style="font-size: 12px;">
        ...
        <tr class="border-bottom border-right grey">
            <td colspan="5" style="color: #fff; font-size: 16px;"><strong>Resumen Medias de Pago</strong></td>
        </tr>
        <tr class="border-bottom border-right center">
            <td width="45%"><strong>Crédito</strong></td>
        ...
        <tr class="border-right">
            <td class="center">{{ number_format($credit_total, 2) }}</td>
    ...
    <table width="100%" class="outline-table" style="font-size: 12px;">
        <tbody>
        <tr class="border-bottom border-right grey">
            <td colspan="3" style="color: #fff; font-size: 16px;"><strong>Resumen Totales</strong></td>
        </tr>
        <tr class="border-bottom border-right center">
